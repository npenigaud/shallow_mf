...
USE MODD_BUDGET,ONLY:TBUDGETCONF_T, TBUDGETDATA_PTR, NBUDGET_U&
...
IF (PARAMMF%CMF_UPDRAFT=='EDKF') THEN
  ...
  &, KSV_LGBEG, KSV_LGEND, PZZ, PDZZ, PSFTH, PSFRV, PEXNM, PPABSM, PRHODREF, PUM, PVM, PTKEM&
  &, PTHM, PRM (:,:, 1), ZTHLM, ZRTM, PSVM, ZTH_UP, PTHL_UP, PRT_UP, PRV_UP, PRC_UP, PRI_UP,&
  & PTHV_UP, PW_UP, PU_UP, PV_UP, ZSV_UP, PFRAC_UP, ZFRAC_ICE_UP, ZRSAT_UP, PTKE_UP, PEMF, PDETR&
  &, PENTR, ZBUO_INTEG, KKLCL, KKETL, KKCTL, ZDEPTH, PDX, PDY, YDSTACK=YLSTACK)
ELSEIF (PARAMMF%CMF_UPDRAFT=='RHCJ') THEN
  ...
  &, PTKEM, PTHM, PRM (:,:, 1), ZTHLM, ZRTM, PSVM, ZTH_UP, PTHL_UP, PRT_UP, PRV_UP, PRC_UP&
  &, PRI_UP, PTHV_UP, PW_UP, PU_UP, PV_UP, ZSV_UP, PFRAC_UP, ZFRAC_ICE_UP, ZRSAT_UP, PEMF&
  &, PDETR, PENTR, ZBUO_INTEG, KKLCL, KKETL, KKCTL, ZDEPTH, YDSTACK=YLSTACK)
ELSEIF (PARAMMF%CMF_UPDRAFT=='RAHA') THEN
  CALL COMPUTE_UPDRAFT_RAHA_OPENACC (D, CST, NEBN, PARAMMF, KSV, GENTR_DETR, ONOMIXLG,&
  & KSV_LGBEG, KSV_LGEND, PZZ, PDZZ, PSFTH, PSFRV, PPABSM, PRHODREF, PUM, PVM, PTKEM, PEXNM&
  &, PTHM, PRM (:,:, 1), ZTHLM, ZRTM, PSVM, ZTH_UP, PTHL_UP, PRT_UP, PRV_UP, PRC_UP, PRI_UP&
...
CALL COMPUTE_MF_CLOUD_OPENACC (D, CST, TURBN, PARAMMF, ICEP, NEBN%LSTATNW, KRR, KRRL, KRRI&
&, ZFRAC_ICE, PRV_UP, PRC_UP, PRI_UP, PEMF, PTHL_UP, PRT_UP, PFRAC_UP, ZTH_UP, PEXNM, ZTHLM&
&, ZRTM, PTHM, PRM, PDZZ, KKLCL, PPABSM, PRHODREF, PRC_MF, PRI_MF, PCF_MF, PSIGMF, PHLC_HRC&
&, PHLC_HCF, PHLI_HRI, PHLI_HCF, PWEIGHT_MF_CLOUD, YDSTACK=YLSTACK)
...
IF (PARAMMF%XIMPL_MF>1.E-10) THEN
  CALL MF_TURB_OPENACC (D, KSV, PARAMMF, ONOMIXLG, KSV_LGBEG, KSV_LGEND, PTSTEP, PDZZ, PRHODJ, ZTHLM&
  &, ZTHVM, ZRTM, PUM, PVM, PSVM, PTKEM, PDTHLDT_MF, PDRTDT_MF, PDUDT_MF, PDVDT_MF, PDSVDT_MF, PDTKEDT_MF&
  &, ZEMF_O_RHODREF, PTHL_UP, PTHV_UP, PRT_UP, PU_UP, PV_UP, ZSV_UP, PTKE_UP, PFLXZTHMF, PFLXZTHVMF&
  &, PFLXZRMF, PFLXZUMF, PFLXZVMF, ZFLXZSVMF, PFLXZTKEMF, PFRAC_UP, YDSTACK=YLSTACK)
ELSE
  CALL MF_TURB_EXPL_OPENACC (D, PARAMMF, PRHODJ, ZTHLM, ZTHVM, ZRTM, PUM, PVM, PTKEM, PDTHLDT_MF, PDRTDT_MF&
  &, PDUDT_MF, PDVDT_MF, PDTKEDT_MF, ZEMF_O_RHODREF, PTHL_UP, PTHV_UP, PRT_UP, PU_UP, PV_UP, PTKE_UP, PFLXZTHMF&
  &, PFLXZTHVMF, PFLXZRMF, PFLXZUMF, PFLXZVMF, PFLXZTKEMF, PFRAC_UP, YDSTACK=YLSTACK)
ENDIF
