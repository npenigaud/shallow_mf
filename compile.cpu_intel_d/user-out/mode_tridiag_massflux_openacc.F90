...
ZY (JI, IKB)=((((PRHODJ (JI, IKB)*PVARM (JI, IKB)/PTSTEP-ZMZM_RHODJ (JI, IKB+IKL)*PF (JI, IKB+IKL)&
&/PDZZ (JI, IKB+IKL))+ZMZM_RHODJ (JI, IKB)*PF (JI, IKB)/PDZZ (JI, IKB))+ZRHODJ_DFDT_O_DZ (JI, IKB+IKL&
...
ELSE
  ...
  &)/PDZZ (JI, IKE+IKL))+ZMZM_RHODJ (JI, IKE)*PF (JI, IKE)/PDZZ (JI, IKE))-ZRHODJ_DFDT_O_DZ (JI, IKE&
  &)*0.5*PIMPL*PVARM (JI, IKE))-ZRHODJ_DFDT_O_DZ (JI, IKE)*0.5*PIMPL*PVARM (JI, IKE-IKL))
