...
IF (KRRL>=1) THEN
  ...
  DO JK=IKTB, IKTE
    ...
    ZE (JI, JK)=BR_EXP (CST%XALPW-CST%XBETAW/PT (JI, JK)-CST%XGAMW*BR_LOG (PT (JI, JK)))
    ...
    ELSE
      ...
      & (JI, JK)/(1.+ZDEDT (JI, JK)*ZLVOCP (JI, JK))*(ZE (JI, JK)*(1.+ZE (JI, JK)/ZEPS)*(-2&
      &.*CST%XBETAW/PT (JI, JK)+CST%XGAMW)/BR_POW(PT (JI, JK), 2)+ZDEDT (JI, JK)*(1.+2.*ZE &
      &(JI, JK)/ZEPS)*(CST%XBETAW/PT (JI, JK)-CST%XGAMW)/PT (JI, JK))-ZDEDT (JI, JK))
    ENDIF
  ...
  IF (KRRI>=1) THEN
    ...
    DO JK=IKTB, IKTE
      ...
      ZE (JI, JK)=BR_EXP (CST%XALPI-CST%XBETAI/PT (JI, JK)-CST%XGAMI*BR_LOG (PT (JI, JK)))
      ZE (JI, JK)=ZE (JI, JK)*ZEPS/(PPABS (JI, JK)-ZE (JI, JK))
      ...
      ELSE
        ...
        & (JI, JK)/(1.+ZDEDT (JI, JK)*ZLSOCP (JI, JK))*(ZE (JI, JK)*(1.+ZE (JI, JK)/ZEPS)*(-2&
        &.*CST%XBETAI/PT (JI, JK)+CST%XGAMI)/BR_POW(PT (JI, JK), 2)+ZDEDT (JI, JK)*(1.+2.*ZE &
        &(JI, JK)/ZEPS)*(CST%XBETAI/PT (JI, JK)-CST%XGAMI)/PT (JI, JK))-ZDEDT (JI, JK))
      ENDIF
