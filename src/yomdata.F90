...
SUBROUTINE SAVELM1 (P, KLUN, KLBOUND)
...
SUBROUTINE SAVELM2 (P, KLUN, KLBOUND)
...
SUBROUTINE SAVELM3 (P, KLUN, KLBOUND)
...
SUBROUTINE SAVELM4 (P, KLUN, KLBOUND)
...
SUBROUTINE SAVELM5 (P, KLUN, KLBOUND)
...
SUBROUTINE SAVERD1 (P, KLUN, KLBOUND)
...
SUBROUTINE SAVERD2 (P, KLUN, KLBOUND)
...
SUBROUTINE SAVERD3 (P, KLUN, KLBOUND)
...
SUBROUTINE SAVERD4 (P, KLUN, KLBOUND)
...
SUBROUTINE SAVERD5 (P, KLUN, KLBOUND)
...
SUBROUTINE SAVERM1 (P, KLUN, KLBOUND)
...
SUBROUTINE SAVERM2 (P, KLUN, KLBOUND)
...
SUBROUTINE SAVERM3 (P, KLUN, KLBOUND)
...
SUBROUTINE SAVERM4 (P, KLUN, KLBOUND)
...
SUBROUTINE SAVERM5 (P, KLUN, KLBOUND)
...
SUBROUTINE SAVEIM1 (P, KLUN, KLBOUND)
...
DO I1 = 1, SIZE (P1, 1)
  IF (P1 (I1) /= Z2 (I1)) THEN
    IF (LLP) PRINT *, CDNAME; LLP = .FALSE.
    WRITE (*, '(3I6," ",1I6)') P1 (I1), Z2 (I1), P1 (I1) - Z2 (I1), I1
  ENDIF
...
SUBROUTINE SAVEIM2 (P, KLUN, KLBOUND)
...
DO I1 = 1, SIZE (P1, 1)
  IF (P1 (I1,I2) /= Z2 (I1,I2)) THEN
    IF (LLP) PRINT *, CDNAME; LLP = .FALSE.
    WRITE (*, '(3I6," ",2I6)') P1 (I1,I2), Z2 (I1,I2), P1 (I1,I2) - Z2 (I1,I2), I1,I2
  ENDIF
...
SUBROUTINE SAVEIM3 (P, KLUN, KLBOUND)
...
DO I1 = 1, SIZE (P1, 1)
  IF (P1 (I1,I2,I3) /= Z2 (I1,I2,I3)) THEN
    IF (LLP) PRINT *, CDNAME; LLP = .FALSE.
    WRITE (*, '(3I6," ",3I6)') P1 (I1,I2,I3), Z2 (I1,I2,I3), P1 (I1,I2,I3) - Z2 (I1,I2,I3), I1,I2,I3
  ENDIF
...
SUBROUTINE SAVEIM4 (P, KLUN, KLBOUND)
...
DO I1 = 1, SIZE (P1, 1)
  IF (P1 (I1,I2,I3,I4) /= Z2 (I1,I2,I3,I4)) THEN
    IF (LLP) PRINT *, CDNAME; LLP = .FALSE.
    WRITE (*, '(3I6," ",4I6)') P1 (I1,I2,I3,I4), Z2 (I1,I2,I3,I4), P1 (I1,I2,I3,I4) - Z2 (I1,I2,I3,I4), I1,I2,I3,I4
  ENDIF
...
SUBROUTINE SAVEIM5 (P, KLUN, KLBOUND)
...
DO I1 = 1, SIZE (P1, 1)
  IF (P1 (I1,I2,I3,I4,I5) /= Z2 (I1,I2,I3,I4,I5)) THEN
    IF (LLP) PRINT *, CDNAME; LLP = .FALSE.
    WRITE (*, '(3I6," ",5I6)') P1 (I1,I2,I3,I4,I5), Z2 (I1,I2,I3,I4,I5), P1 (I1,I2,I3,I4,I5) - Z2 (I1,I2,I3,I4,I5), I1,I2,I3,I4,I5
  ENDIF
