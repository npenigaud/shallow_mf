...
IF(PARAMMF%LRELAX_ALPHA_MF) THEN
  DO JK=1, IKT
    DO JIJ=IIJB, IIJE
      ...
      ZMEMF(JIJ, JK)=-PEMF(JIJ, JK)*ZRELAX_ALPHA_COEFF(JIJ, JK)
    END DO
  END DO
ELSE
...
DO JK=1, IKT
  DO JIJ=IIJB, IIJE
    PFLXZTHMF(JIJ, JK) = PEMF(JIJ, JK)*ZRELAX_ALPHA_COEFF(JIJ, JK)*&
                               & (PTHL_UP(JIJ, JK)-PFLXZTHMF(JIJ, JK))
    PFLXZRMF(JIJ, JK) = PEMF(JIJ, JK)*ZRELAX_ALPHA_COEFF(JIJ, JK)*&
                              & (PRT_UP(JIJ, JK)-PFLXZRMF(JIJ, JK))
    PFLXZTHVMF(JIJ, JK) = PEMF(JIJ, JK)*ZRELAX_ALPHA_COEFF(JIJ, JK)*&
                                & (PTHV_UP(JIJ, JK)-PFLXZTHVMF(JIJ, JK))
  END DO
END DO
  ...
  DO JK=1, IKT
    DO JIJ=IIJB, IIJE
      PFLXZUMF(JIJ, JK) = PEMF(JIJ, JK)*ZRELAX_ALPHA_COEFF(JIJ, JK)*&
                                & (PU_UP(JIJ, JK)-PFLXZUMF(JIJ, JK))
      PFLXZVMF(JIJ, JK) = PEMF(JIJ, JK)*ZRELAX_ALPHA_COEFF(JIJ, JK)*&
                                & (PV_UP(JIJ, JK)-PFLXZVMF(JIJ, JK))
    END DO
  END DO
ELSE
  PFLXZUMF(:,:) = 0.
...
DO JSV=1,KSV 
  ...
  DO JK=1, IKT
    DO JIJ=IIJB, IIJE
      PFLXZSVMF(JIJ, JK, JSV) = PEMF(JIJ, JK)*ZRELAX_ALPHA_COEFF(JIJ, JK)*&
