...
CONTAINS
SUBROUTINE MF_TURB_EXPL_OPENACC (D, PARAMMF, PRHODJ, PTHLM, PTHVM, PRTM, PUM, PVM, PTKEM, PTHLDT&
&, PRTDT, PUDT, PVDT, PTKEDT, PEMF, PTHL_UP, PTHV_UP, PRT_UP, PU_UP, PV_UP, PTKE_UP, PFLXZTHLMF&
&, PFLXZTHVMF, PFLXZRMF, PFLXZUMF, PFLXZVMF, PFLXZTKEMF, PFRAC_UP, YDSTACK)
...
DO JK=1, IKT
  ...
  PFLXZTHLMF (JI, JK)=PEMF (JI, JK)*ZRELAX_ALPHA_COEFF (JI, JK)*(PTHL_UP (JI, JK)-PFLXZTHLMF (JI, JK))
  ...
  ZFLXZTHSMF (JI, JK)=PEMF (JI, JK)*ZRELAX_ALPHA_COEFF (JI, JK)*(ZTHS_UP (JI, JK)-ZTHSM (JI, JK))
...
IF (PARAMMF%LMIXTKE) THEN
  ...
  DO JK=IKB, IKE-IKL, IKL
    ...
    PTKEDT (JI, JK)=(PFLXZTKEMF (JI, JK)-PFLXZTKEMF (JI, JK+IKL))/PRHODJ (JI, JK)
